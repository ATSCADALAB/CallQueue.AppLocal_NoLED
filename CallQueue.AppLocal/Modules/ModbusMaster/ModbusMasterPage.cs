...
{
    public partial class ModbusMasterPage : UserControl
    {
        ...
        public ModbusMasterPage(UnitOfWork unitOfWork, ModbusManager modbusManager)
        {
            InitializeComponent();
        ...
        private void Create()
        {
            ...
            {
                IsBusy = true;
                transitionManager1.OpenFormAsync(this, this, () => new frmEditModbusMasterParameter(null, unitOfWork, modbusManager), () =>
                {
                    IsBusy = false;
                    Reload();
                    RaiseCommandsCanExecuteChanged();
        ...
        private void Edit()
        {
            ...
            {
                IsBusy = true;
                var editModbusParam = (gridView1.GetRow(SelectedIndex) as ModbusMasterParameter);
                transitionManager1.OpenFormAsync(this, this, () => new frmEditModbusMasterParameter(editModbusParam, unitOfWork, modbusManager), () =>
                {
                    IsBusy = false;
                    Reload();
                    RaiseCommandsCanExecuteChanged();
        ...
        private void Delete()
        {
            try
            {
                ...
                {
                    int id = (gridView1.GetRow(SelectedIndex) as ModbusMasterParameter).Id;
                    modbusManager.DeleteModbusMasterParameter(id);
                    Reload();
                    RaiseCommandsCanExecuteChanged();
                }
            }
        ...
        private void Reload()
        {
            ...
            {
                IsBusy = true;
                var modbusParams = modbusManager.GetAllModbusMasterParameters();
                gridControl1.DataSource = modbusParams;
